            ...
            <div class="card mobile-card">
                <div class="card-header bg-brown text-white d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <h5 class="mb-0 me-3">Filter Already → Done</h5>
                        <span class="badge bg-light text-dark">
                            <i class="fas fa-info-circle"></i> Data Done yang berasal dari Already
                        </span>
                    </div>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="mobile-search-container d-block d-md-none">
                        ...
                        <div class="mobile-search-form" id="mobileSearchForm" style="display: none;">
                            <form method="get" action="<?= base_url('database/filter_already_done') ?>" class="mobile-form">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url('database/filter_already_done') ?>" class="btn btn-reset">
                    ...
                    <div class="desktop-search-container d-none d-md-block p-3">
                        <form method="get" action="<?= base_url('database/filter_already_done') ?>" class="desktop-form">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <a href="<?= base_url('database/filter_already_done') ?>" class="btn btn-brown-light btn-sm">
                                        <i class="fas fa-times"></i> Reset
                                    </a>
                                </div>
                            </div>
...
<div class="modal fade" id="registerUlangStatisticsModal" tabindex="-1" aria-labelledby="registerUlangStatisticsModalLabel" aria-hidden="true">
    ...
    <script>
const FILTER_ALREADY_DONE_BASE_URL = '<?= base_url('database/filter_already_done') ?>';

function buildFilterAlreadyDoneRedirectUrl() {
    const params = new URLSearchParams(window.location.search);
    let redirectUrl = FILTER_ALREADY_DONE_BASE_URL;
    const queryParams = [];
...
function saveRow(button) {
    ...
    .then(result => {
        ...
        if (result.success) {
            ...
            setTimeout(() => {
                window.location.href = buildFilterAlreadyDoneRedirectUrl();
            }, 1000);
...
function deleteData(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
        const redirectUrl = buildFilterAlreadyDoneRedirectUrl();
