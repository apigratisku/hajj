                ...
                <div class="card-body p-0">
                    ...
                    <div class="mobile-search-container d-block d-md-none">
                        ...
                        <div class="mobile-search-form" id="mobileSearchForm" style="display: none;">
                            <form method="get" action="<?= base_url('database/filter_cancel') ?>" class="mobile-form">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url('database/filter_cancel') ?>" class="btn btn-reset">
                    ...
                    <div class="desktop-search-container d-none d-md-block p-3">
                        <form method="get" action="<?= base_url('database/filter_cancel') ?>" class="desktop-form">
                            <input type="hidden" name="status" value="1">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <a href="<?= base_url('database/filter_cancel') ?>" class="btn btn-brown-light btn-sm">
                                        <i class="fas fa-times"></i> Reset
                                    </a>
                                </div>
                            </div>
...
<!-- Operator Statistics Modal (disabled on Filter Already page) -->
...
<div class="modal fade" id="registerUlangStatisticsModal" tabindex="-1" aria-labelledby="registerUlangStatisticsModalLabel" aria-hidden="true">
    ...
    <script>
const FILTER_CANCEL_BASE_URL = '<?= base_url('database/filter_cancel') ?>';

function buildFilterAlreadyRedirectUrl() {
    const params = new URLSearchParams(window.location.search);
    let redirectUrl = FILTER_CANCEL_BASE_URL;
    const queryParams = [];
