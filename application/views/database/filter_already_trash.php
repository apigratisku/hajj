            ...
            <div class="card mobile-card">
                <div class="card-header bg-brown text-white d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 me-3">Filter Already -> Trash</h5>
                    </div>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="mobile-search-container d-block d-md-none">
                        ...
                        <div class="mobile-search-form" id="mobileSearchForm" style="display: none;">
                            <form method="get" action="<?= base_url('database/filter_already_trash') ?>" class="mobile-form">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url('database/filter_already_trash') ?>" class="btn btn-reset">
                    ...
                    <div class="desktop-search-container d-none d-md-block p-3">
                        <form method="get" action="<?= base_url('database/filter_already_trash') ?>" class="desktop-form">
                            <input type="hidden" name="status" value="1">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <a href="<?= base_url('database/filter_already_trash') ?>" class="btn btn-brown-light btn-sm">
                                        <i class="fas fa-times"></i> Reset
                                    </a>
                                </div>
                            </div>
