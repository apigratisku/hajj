    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card mobile-card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('user/add'); ?>" method="post" class="modern-form">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control modern-input" id="username" name="username" value="<?= set_value('username'); ?>" placeholder="Masukkan username" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="password-input-group">
                                        <input type="password" class="form-control modern-input" id="password" name="password" placeholder="Masukkan password" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control modern-input" id="nama_lengkap" name="nama_lengkap" value="<?= set_value('nama_lengkap'); ?>" placeholder="Masukkan nama lengkap" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="status" name="status" value="1" <?= set_value('status') ? 'checked' : ''; ?>>
