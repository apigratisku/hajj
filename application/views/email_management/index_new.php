            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-envelope me-2"></i>Manajemen Email (New Implementation)
                    </h5>
                    <div class="btn-group">
                        <a href="<?= base_url('email_new/create') ?>" class="btn btn-success btn-sm">
                            <i class="fas fa-plus"></i> Tambah Email
                        </a>
                        <button type="button" class="btn btn-info btn-sm" onclick="checkAccounts()">
                            <i class="fas fa-sync-alt"></i> Refresh
                        </button>
                        <a href="<?= base_url('email_new/test_connection') ?>" class="btn btn-warning btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <a href="<?= base_url('email_new/edit/' . urlencode($account['email'])) ?>" 
...
function checkAccounts() {
    ...
    fetch('<?= base_url('email_new/check_accounts') ?>', {
        method: 'GET',
        headers: {
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="<?= base_url('email_new/edit/') ?>${encodeURIComponent(account.email)}" 
                            class="btn btn-warning" title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-danger" 
...
document.getElementById('confirmDelete').addEventListener('click', function() {
    if (deleteEmailAddress) {
        window.location.href = '<?= base_url('email_new/delete/') ?>' + encodeURIComponent(deleteEmailAddress);
    }
});
...
function showDebugInfo() {
    console.log('=== EMAIL NEW DEBUG ===');
    console.log('Current URL:', window.location.href);
    console.log('Base URL:', '<?= base_url() ?>');
    console.log('Check accounts URL:', '<?= base_url('email_new/check_accounts') ?>');
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('=== EMAIL NEW PAGE LOADED ===');
