        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: white;">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Data Agent</h5>
                </div>
                <div class="card-body">
                    <?= validation_errors('<div class="alert alert-danger">', '</div>') ?>
                    
                    <?= form_open('master/edit/'.$agent->id_agent, ['method' => 'post']) ?>
                        <div class="row mb-3">
                            <label for="nama_agent" class="col-sm-3 col-form-label">Nama Agent <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_agent" name="nama_agent" value="<?= set_value('nama_agent', $agent->nama_agent) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="hp" name="hp" value="<?= set_value('hp', $agent->hp) ?>" required>
                            </div>
                        </div>
