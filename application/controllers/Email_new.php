...
class Email_new extends CI_Controller {
    ...
    public function index() {
        try {
            $data['title'] = 'Manajemen Email (cPanel) - New';
            ...
            $this->load->view('email_management/index_new', $data);
            $this->load->view('templates/footer');
        } catch (Exception $e) {
            log_message('error', 'Error in Email_new index: ' . $e->getMessage());
    ...
    public function create() {
        try {
            ...
            log_message('error', 'Error in Email_new create: ' . $e->getMessage());
    ...
    public function edit($email) {
        try {
            ...
            log_message('error', 'Error in Email_new edit: ' . $e->getMessage());
    ...
    public function delete($email) {
        try {
            ...
            log_message('error', 'Error in Email_new delete: ' . $e->getMessage());
    ...
    public function check_accounts() {
        try {
            ...
            log_message('error', 'Error in Email_new check_accounts: ' . $e->getMessage());
    ...
    public function test_connection() {
        try {
            ...
            log_message('error', 'Error in Email_new test_connection: ' . $e->getMessage());
