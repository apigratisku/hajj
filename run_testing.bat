@echo off
echo Starting Telegram Notification Scheduler - Testing Mode...
...
REM Testing timing (very fast for testing)
set SCHEDULE_CHECK_INTERVAL=1
set OVERDUE_CHECK_INTERVAL=2

REM Testing cleanup time
set CLEANUP_HOUR=0

REM Testing display settings
set MAX_PARTICIPANTS_DISPLAY=2
set MAX_OVERDUE_SCHEDULES=5

REM Testing logging
set LOG_LEVEL=DEBUG
set LOG_FILE=telegram_scheduler_testing.log

REM Testing API settings
set API_TIMEOUT=5
...
echo Starting scheduler in testing mode...
