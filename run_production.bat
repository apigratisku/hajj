@echo off
echo Starting Telegram Notification Scheduler - Production Mode...
...
REM Production timing (optimized for production)
set SCHEDULE_CHECK_INTERVAL=10
set OVERDUE_CHECK_INTERVAL=60

REM Production cleanup time
set CLEANUP_HOUR=2

REM Production display settings
set MAX_PARTICIPANTS_DISPLAY=5
set MAX_OVERDUE_SCHEDULES=50

REM Production logging
set LOG_LEVEL=INFO
set LOG_FILE=telegram_scheduler_production.log

REM Production API settings
set API_TIMEOUT=30
...
echo Starting scheduler in production mode...
