<?php
/**
 * Test script untuk memverifikasi timezone Asia/Hong_Kong API
 */

// Load CodeIgniter
require_once 'index.php';

echo "<h2>Test Timezone Asia/Hong_Kong API</h2>";
...
if ($http_code == 200) {
    ...
    if ($data && $data['success']) {
        ...
        // Verifikasi timezone
        if ($data['timezone'] == 'Asia/Hong_Kong') {
            echo "✅ <strong>Timezone correct: Asia/Hong_Kong</strong><br>";
        } else {
            echo "❌ <strong>Timezone incorrect: Expected Asia/Hong_Kong, got " . $data['timezone'] . "</strong><br>";
        }
    } else {
...
echo "<h3>2. Test Schedule Notifications dengan Timezone Hong Kong</h3>";
...
echo "<h3>3. Test Overdue Schedules dengan Timezone Hong Kong</h3>";
...
echo "✅ Current Time (Asia/Hong_Kong): <strong>$current_time</strong><br>";
...
// Verifikasi timezone name
if (date_default_timezone_get() == 'Asia/Hong_Kong') {
    echo "✅ <strong>Timezone name correct: Asia/Hong_Kong</strong><br>";
} else {
    echo "❌ <strong>Timezone name incorrect: Expected Asia/Hong_Kong, got " . date_default_timezone_get() . "</strong><br>";
}

echo "<h3>6. Test Notifikasi Timezone Hong Kong</h3>";
...
echo "<h3>7. Perbandingan Timezone</h3>";

// Set timezone untuk perbandingan
$original_tz = date_default_timezone_get();
$timezones = ['UTC', 'Asia/Hong_Kong', 'Asia/Jakarta', 'Asia/Shanghai'];

echo "<table border='1' cellpadding='5' style='border-collapse: collapse;'>";
echo "<tr style='background-color: #f0f0f0;'>";
echo "<th>Timezone</th><th>Current Time</th><th>Offset</th>";
echo "</tr>";
...
echo "Bot Telegram akan menggunakan waktu Asia/Hong_Kong (GMT+8) untuk semua notifikasi.<br>";
